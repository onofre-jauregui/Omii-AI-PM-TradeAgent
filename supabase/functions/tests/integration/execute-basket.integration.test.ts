 ...
 *
 * This session found and fixed a second bug in the same fill-tracking logic
 * the earlier flatten-outcome fix touched: a leg that returns success:true
 * but never actually filled (status "open" — e.g. no real liquidity, or a
