...
-- All event types default true; daily_summary is the first one with backend enforcement.
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS phone TEXT,
  ADD COLUMN IF NOT EXISTS notification_prefs JSONB NOT NULL DEFAULT
    '{"channel":"email","daily_summary":true,"trade_executed":true,"position_closed":true,"stop_loss_hit":true,"agent_alerts":true}'::jsonb;
